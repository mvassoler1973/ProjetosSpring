...
import catalago.core.exception.EntidadeNaoEncontradaException;
import catalago.core.exception.NegocioException;
import catalago.core.exception.RangeFiltersException;
import catalago.core.exception.ValidacaoException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(RangeFiltersException.class)
	public ResponseEntity<?> handleRangeFiltersException(RangeFiltersException ex, WebRequest request) {
		Problem problema = this
				.createProblemBuilder(HttpStatus.BAD_REQUEST, ProblemTypeHandler.RANGE_FILTER_INVALID, ex.getMessage())
				.userMessage(ex.getMessage()).build();
		return this.handleExceptionInternal(ex, problema, new HttpHeaders(), HttpStatus.CONFLICT, request);
	}
